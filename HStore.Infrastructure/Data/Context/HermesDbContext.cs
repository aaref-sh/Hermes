...
/// <summary>
/// Represents the database context for the HStore application, responsible for managing entities and their relationships.
/// </summary>
public class HStoreDbContext(DbContextOptions<HStoreDbContext> options) : IdentityDbContext<User, Role, int>(options)
{
