...
namespace HStore.Infrastructure.Data.Context;

public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<HStoreDbContext>
{
    /// <summary>
    ...
    /// </returns>
    public HStoreDbContext CreateDbContext(string[] args)
    {
        ...
        var builder = new DbContextOptionsBuilder<HStoreDbContext>();
        builder.UseSqlServer(connectionString);
        return new HStoreDbContext(builder.Options);
    }
}